...
public class ServiceImplementation implements ProductService {
	...
	public ServiceImplementation() {
		...
		map.put(1L, new Product(1L, "Iceglass", "glass", new BigDecimal("60.00"), 42, "Ice style chess set with traditional figure shapes.", "Iceglass"));
		map.put(2L, new Product(2L, "Club", "plastic", new BigDecimal("75.00"), 60, "A comfortable and very popular product for training and tournements.", "Club"));
